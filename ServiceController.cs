...
namespace GymProject1.Controllers
{
    public class ServiceController : Controller
    {
        ...
        // 4. EKLEME (POST) - DÜZELTİLDİ: Description Eklendi
        [HttpPost]
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Admin")]
        public async Task<IActionResult> Create([Bind("ServiceId,Name,DurationMinutes,Price,Description")] Service service)
        {
